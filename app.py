...
async def geolocate(request):
    ...
    if country:
        ...
        return JSONResponse({"message": "Could not geocode request."})
...
async def geolocate_ip(request):
    ...
    if country:
        return JSONResponse({"latitude":country["geo"]["latitude"],"longitude":country["geo"]["longitude"]})
    else:
        return JSONResponse({"message": "Could not geocode request."})
...
async def countries_list(request):
    return JSONResponse(app.countries)
...
async def countries_detail(request):
    ...
    if country:
        ...
        return JSONResponse({"message": "Country code not found."})
